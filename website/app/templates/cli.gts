<template>
  <div class="container mx-auto p-4">
    ...
    <section class="mb-8">
      ...
      <p>
        Welcome to the command-line interface (CLI) documentation. This tool
        helps you manage your project efficiently.
      </p>
    </section>
    ...
    <section class="mb-8">
      ...
      <p>
        To use the CLI, you first need to install it globally via npm (or your
        preferred package manager):
      </p>
      <pre class="bg-gray-100 p-2 rounded"><code>npm install -g
          your-cli-package-name</code></pre>
      <p class="mt-2">
        Alternatively, you can run it directly using npx without global
        installation:
      </p>
      <pre class="bg-gray-100 p-2 rounded"><code>npx your-cli-package-name
          &lt;command&gt;</code></pre>
    </section>
    ...
    <section class="mb-8">
      ...
      <pre class="bg-gray-100 p-2 rounded"><code>your-cli-package-name
          &lt;command&gt; [options]</code></pre>
    </section>
    ...
    <section class="mb-8">
      ...
      <div class="mb-4 p-4 border rounded">
        ...
        <p class="mt-1">Initializes a new project or sets up the CLI in an
          existing project.</p>
        <pre class="bg-gray-100 p-2 mt-2 rounded"><code>your-cli-package-name
            init [project-name]</code></pre>
      </div>
      ...
      <div class="mb-4 p-4 border rounded">
        ...
        <pre class="bg-gray-100 p-2 mt-2 rounded"><code>your-cli-package-name
            build [--output path/to/output]</code></pre>
      </div>
      ...
      <div class="mb-4 p-4 border rounded">
        ...
        <pre class="bg-gray-100 p-2 mt-2 rounded"><code>your-cli-package-name
            deploy [--target production]</code></pre>
      </div>
    </section>
